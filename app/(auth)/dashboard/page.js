    ...
    <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <PerformanceMetric name="Truthfulness" value={32} color="bg-[#038c5e]" />
          <PerformanceMetric name="Demerits Self Reported" value={10} color="bg-[#f00c08]" />
          <PerformanceMetric name="Test Report" value={80} color="bg-[#ebad3b]" />
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            { src: "/Reports.png", alt: "Test Report" },
            ...
            <button key={index} className="rounded-lg overflow-hidden">
              <Image 
                src={item.src} 
                alt={item.alt} 
                width={250} 
